...
public class PhotographerDao extends AbstractDao implements IPhotographerDao {
    ...
    private static final String FIND_ALL = "SELECT * FROM photographer";
    ...
    public PhotographerModel getEntity(long id) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                photographer.setCameraModel(new CameraDao().getEntity(resultSet.getInt("camera_id")));
            }
    ...
    public void createEntity(PhotographerModel photographerModel) {
        try {
            ...
            stmt.setLong(2, photographerModel.getCameraModel().getId());
            stmt.executeUpdate();
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        } finally {
    ...
    public void updateEntity(PhotographerModel photographerModel) {
        try {
            ...
            stmt.setString(1, photographerModel.getName());
            stmt.setInt(2, photographerModel.getCameraModel().getId());
            stmt.executeUpdate();
